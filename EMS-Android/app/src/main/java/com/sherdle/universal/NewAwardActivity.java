...
public class NewAwardActivity  extends AppCompatActivity {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        View view= LayoutInflater.from(getActivity()).inflate(R.layout.activity_award,null);
    ...
    private void addInfoForSpinner(){
        ArrayAdapter<String>schoolAdapter=new ArrayAdapter<T>(android.R.layout.simple_spinner_dropdown_item, LocalUserVariable.school);
        ArrayAdapter<String>yearAdapter=new ArrayAdapter<T>(android.R.layout.simple_spinner_dropdown_item, LocalUserVariable.year);
        ArrayAdapter<String>sportAdapter=new ArrayAdapter<T>(android.R.layout.simple_spinner_dropdown_item, LocalUserVariable.sport);
        ArrayAdapter<String>levelAdapter=new ArrayAdapter<T>(android.R.layout.simple_spinner_dropdown_item,new String[]{"Varsity","JV"});
