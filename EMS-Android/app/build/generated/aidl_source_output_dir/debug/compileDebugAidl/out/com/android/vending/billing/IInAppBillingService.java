 ...
 * Original file: /Users/mahmoudkhamis/Files/Jeremy/JeremyAndroid/app/src/main/aidl/com/android/vending/billing/IInAppBillingService.aidl
 */
...
/**
     ...
     * @param skusBundle bundle containing a StringArrayList of SKUs with name "ITEM_ID_LIST"
     * @return Bundle containing the following name-value pairs
...
/**
     ...
     * If the purchase is successful, the result data will contain the following name-value pairs
     *         "RESPONSE_CODE" with int value, RESULT_OK(0) if success, other response codes on
     *              failure as listed above.
     ...
     *                                  was signed with the private name of the developer
     */
